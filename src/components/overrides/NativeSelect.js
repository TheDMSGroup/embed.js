...
export default class NativeSelectComponent extends BaseComponent {
    ...
    static get builderInfo() {
        return {
            ...
            schema: NativeSelectComponent.schema()
        };
    }
    ...
    get defaultSchema() {
        return NativeSelectComponent.schema();
    }
